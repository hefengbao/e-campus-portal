...
class LectureResource extends Resource
{
    ...
    protected static ?string $label = '学术讲座';
    protected static ?string $pluralLabel = '学术讲座';
    protected static ?string $modelLabel = '学术讲座';
    protected static ?string $pluralModelLabel = '学术讲座';
